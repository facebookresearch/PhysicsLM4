...
#
# Zeyuan's modification: catch json.JSONDecodeError error because some datasets may have empty/invalid entries
#
...
def read_jsonl(
    ...
    print(file_path, position, block_size, offset, current_iter)
        ...
        while line := file.readline():
            ...
            if (current_line - 1) % block_size == offset:
                ...
                try:
                    ...
                    print(f"[JSON ERROR] Failed to parse line at byte offset {file.tell()} - line content:")
                    print(repr(line))  # shows whitespace or \n
                    continue
